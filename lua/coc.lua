...
keyset("i", "<C-u>", 'coc#float#has_scroll() ? "<c-r>=coc#float#scroll(0)<cr>" : "<Right>"', opts)
keyset("i", "<C-d>", 'coc#float#has_scroll() ? "<c-r>=coc#float#scroll(1)<cr>" : "<Left>"', opts)
...
keyset("n", "<space>a", ":Telescope coc workspace_diagnostics<cr>", opts)
-- Manage extensions
